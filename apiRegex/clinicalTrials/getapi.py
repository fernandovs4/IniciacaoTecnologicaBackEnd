...
def todos_hospitais(cache = False, farmas = False):
    ...
    if cache:
        with open("/home/fernando/WORKSPACE/IniciacaoTecnologica/SistemaWeb/api/apiRegex/clinicalTrials/cacheResults.json", "r") as file:
    ...
    with open("/home/fernando/WORKSPACE/IniciacaoTecnologica/SistemaWeb/api/apiRegex/clinicalTrials/farmas.json", "w") as file:
        json.dump(LeadSponsorName, file, indent=4)
    if farmas:
        return LeadSponsorName
    with open("/home/fernando/WORKSPACE/IniciacaoTecnologica/SistemaWeb/api/apiRegex/clinicalTrials/cacheResults.json", "w") as file:
